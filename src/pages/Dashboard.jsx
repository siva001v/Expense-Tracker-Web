      ...
      <div className="dashboard__container">
        ...
        <div className="dashboard__main">
          <div className="dashboard__statistics">
            <AnalyticsStats data={expenseData} />

            <div className="dashboard__statistics-summary">
              <p>SUMMARY</p>
              <div className="dashboard__statistics-summary-pie-chart">
                <SummaryPieChart summary={summary ?? []} />
              </div>
            </div>

            <div className="dashboard__statistics-trends">
              <p>TRENDS</p>
              <div className="dashboard__statistics-trends-line-chart">
          ...
          <div className="dashboard__content">
            <div className="dashboard__content-header">
              ...
              <div className="dashboard__content-header-action">
                ...
                />
                <button
                  className="dashboard__button-add"
                  type="button"
